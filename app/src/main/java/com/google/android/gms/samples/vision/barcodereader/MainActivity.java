...
import static com.google.android.gms.samples.vision.barcodereader.R.id.barcode_value;
...
public class MainActivity extends Activity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        barcodeValue = (TextView)findViewById(barcode_value);
...
/*
        ...
        //adapterの準備
        //表示するカラム名
        String[] from = {"barcode","item","disposal"};
        //バインドするViewソース
...
*/
        ...
        findViewById(R.id.barcode_disp).setOnClickListener(this);
    }
